...
import torch
from utils.transformations import pose_to_affine, affine_to_pose, quaternion_distance, \
    rotation_from_axis_angle, axis_angle_from_rotation
...
class PathComposite(object):
    ...
    def add(self, geom, aggregate=True):
        ...
        if isinstance(self.path_length, float):
            print("bug")
        self.dv.append(self.path_length.clone())
